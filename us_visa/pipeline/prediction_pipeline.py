...
class USvisaData:
    # initialize all feature that production model have, except the label
    def __init__(self,
                continent,
   ...
   # method 2: convert all feature into DataFrame format
   ...
   # method 1: convert all feature into dictionary format
